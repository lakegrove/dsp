...
> Question: We can use PWD to print working directory to see where out new directory is and then hit ls to list what's in this new directory, it should be blank.
